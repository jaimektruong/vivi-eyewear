...
function PaymentPage() {
  return (
    <div className="container-fluid d-flex justify-content-center ">
      ...
      <div  className="Payment_Page col-md-6 col-xl-10" >
        <div className="Content_Payment">
          <h2 className="title">I. Chính sách giao nhận tại ViVi Eyewear</h2>
          <ul>
            <li>Phí ship</li>
            <p>Đối với sản phẩm dưới 500.000 VNĐ: phí ship sẽ dao động từ 20.000 VNĐ đến 40.000 VNĐ tùy theo Đơn vị vận chuyển. Đối với sản phẩm trên 500.000 VNĐ: phí ship sẽ dao động từ 15.000 VNĐ đến 30.000 VNĐ tùy theo Đơn vị vận chuyển.</p>
